...
<Modal class="max-h-[96%] max-w-[90%]" modal_open={typing_assistance_modal_opened}>
  ...
  <div
    class={cl_join(
      'mt-4 h-[580px] w-[506px]',
      $usage_table.isFetching && 'placeholder animate-pulse rounded-lg'
    )}
  >
    {#if !$usage_table.isFetching && $usage_table.isSuccess}
